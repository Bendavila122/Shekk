...
function Thread() {
  ...
  return (
    <AppShell>
      ...
      <div className="fixed bottom-[86px] left-1/2 z-30 w-full max-w-[430px] -translate-x-1/2 border-t border-border bg-card/95 px-4 py-3 backdrop-blur lg:sticky lg:bottom-0 lg:left-auto lg:max-w-none lg:translate-x-0">
        {send.isError && (
