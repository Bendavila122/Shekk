...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
  ...
  },
  {
    ...
    services: [
      ...
      { id: "uni", name: "Uni & study", emoji: "🎓", blurb: "Applications, credit transfer, tuition", status: "live", to: "/explore/uni", detail: ["Masa, mechina and one-year programs", "Credit transfer and transcripts for home", "Tuition timing and paying from Shekk"] },
